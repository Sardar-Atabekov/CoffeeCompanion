    ...
    <footer className="bg-coffee-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              <h3 className="text-2xl font-display font-bold">Paris Coffee</h3>
            </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">
              {translate("footer.menu", language)}
            </h4>
            <ul className="space-y-2 text-coffee-200">
              <li>
                <a href="#" className="hover:text-white transition-colors">
                  {translate("menu.hotDrinks", language)}
                </a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">
                  {translate("menu.coldDrinks", language)}
                </a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">
                  {translate("menu.pastries", language)}
                </a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">
                  {translate("menu.desserts", language)}
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">
              {translate("footer.contact", language)}
            </h4>
            <ul className="space-y-2 text-coffee-200">
              <li>📍 {translate("footer.address", language)}</li>
              <li>📞 {translate("footer.phone", language)}</li>
              <li>✉️ {translate("footer.email", language)}</li>
              <li>🕐 {translate("footer.hours", language)}</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-coffee-700 mt-8 pt-8 text-center text-coffee-300">
          <p>
            &copy; {translate("footer.copyright", language)} |{" "}
